...
// }
// 	if(empty($error)){
// 		$stmt = $conn->prepare("INSERT INTO adminlogin VALUES(NULL,:fn,:ln,:un,:pw,:em,NOW(),NOW() )");
// 		$data = array(
// 			":fn"=>$_POST['firstname'],
// 			":ln"=>$_POST['lastname'],
// 			":un"=>$_POST['username'],
...
<head>
    ...
    <title>PHP Auth Admin - Register</title>
    ...
    <link href="css/php-custom.css" rel="stylesheet">
